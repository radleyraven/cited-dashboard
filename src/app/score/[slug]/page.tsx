        ...
        {gaps.map((gap, i) => (
          <details key={i} className="gap-card" style={{ background: '#fff', borderRadius: '12px', overflow: 'hidden', borderLeft: `4px solid ${gap.color || (gap.impact === 'High' ? '#EF4444' : '#D4A830')}` }}>
            ...
            >
              ...
              <span className="chevron" style={{ fontSize: '14px', color: '#00BFA6', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '28px', height: '28px', borderRadius: '50%', background: 'rgba(0,191,166,0.1)', flexShrink: 0, marginLeft: '12px' }}>▾</span>
            </summary>
