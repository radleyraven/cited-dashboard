...
export async function POST(request: Request) {
  try {
    ...
    const payload = {
      ...
      voice_archetype: body.voiceArchetype?.trim() || null,
      voice_signature_phrase: body.voiceSignaturePhrase?.trim() || null,
      voice_memorable_client: body.voiceMemorableClient?.trim() || null,
