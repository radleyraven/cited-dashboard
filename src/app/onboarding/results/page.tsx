          ...
          {primaryCompetitor && (
            <div style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: '14px', overflow: 'hidden', marginBottom: '14px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
                ...
                {/* Radley */}
                <div style={{ padding: '20px 20px 20px 20px', borderRight: '1px solid #f1f5f9', display: 'flex', flexDirection: 'column' }}>
                ...
                {/* Competitor */}
                <div style={{ padding: '20px', background: '#fafbfc', display: 'flex', flexDirection: 'column' }}>
